...
# ---
gamma = 0.7 #0.9 #0.99 #0.3 # #0.99 #0.3 #0.99  # 割引係数
hidden_size = 80 #28 #50 # <- 50層だとバッチサイズ=32のepoch=1で1エピソード約3時間かかっていた # Q-networkの隠れ層のニューロンの数
...
feature_num = 10 + 9*3 #10 #11 #10 #11 #10 #11
nn_output_size = 3
