...
def train_and_generate_model():
    ...
    if is_param_tune_with_optuna:
     ...
     param = {'max_depth':2, 'eta':0.1, 'objective':'binary:logistic', 'verbosity':0, 'n_thread':4,
